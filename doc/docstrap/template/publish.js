  ...
  if (members.classes.length) {
    ...
    members.classes.forEach(function(c) {
      if (!hasOwnProp.call(seen, c.longname)) {
        ...
        nav.class.members.push(linkto(c.longname, c.longname.replace("module:", "") + " <span style='font-weight: bold'>(" + c.description.replace(/<[^>]+>/g, "")+")</span>"));
      }
  ...
  if (members.globals.length) {
    members.globals.forEach(function(g) {
      if (g.kind !== 'typedef' && !hasOwnProp.call(seen, g.longname)) {
          ...
          nav.global.members.push(linkto(g.longname, g.longname.replace("module:", "") + " <span style='font-weight: bold'>(" + g.description.replace(/<[^>]+>/g, "")+")</span>"));
      }
